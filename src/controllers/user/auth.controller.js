...
export const resetDatabase = async (req, res) => {
  const resetQueries = `
    ...
    ('Seashell 1', '', 250, 'Earrings', 10),
    ('Seashell 2', '', 250, 'Earrings', 10),
    ...
    ('Emerald Seas Drop (dark green)', '', 450, 'Necklaces', 10),
    ('Emerald Seas Drop (light green)', '', 450, 'Necklaces', 10),
    ...
    ('The OG Chain', '', 490, 'Waist Chains', 10),
